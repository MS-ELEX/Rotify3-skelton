...
var require_configent = __commonJS({
  "node_modules/configent/configent.js"(exports, module) {
    var { existsSync, readdirSync } = (init_fs(), fs_exports);
    var { resolve, dirname } = (init_path(), path_exports);
    var instances = {};
    ...
    function configent(configentOptions) {
      configentOptions = __spreadValues(__spreadValues({}, _defaults), configentOptions);
      ...
      function buildConfig() {
        ...
        if (!instances[hash] || !cacheConfig) {
          instances[hash] = __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useDetectDefaults && getDetectDefaults()), usePackageConfig && getPackageConfig()), useConfig && getUserConfig()), useEnv && getEnvConfig());
        }
